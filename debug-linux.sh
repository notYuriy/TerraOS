...
do
        obj="$(basename -- $name)"
        eval "$CC -o Obj/$obj -c $name -IInclude -std=gnu99 -ffreestanding -O2 -Wall -Wextra -mno-sse -mno-sse2 -mno-sse3 -mcmodel=large -mno-red-zone -funroll-loops -g"
done
...
qemu-system-x86_64 -cdrom Iso/TerraOS.iso -m 128M -no-reboot -s